            ...
            <div class="row align-items-center">
                <div class="col-md-12 mt-1">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Liste des consultation</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="card-header">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6">
                    <h5>
                        <i class="feather icon-file-text"></i>Liste de consultations de 
                        <code style="font-size: 18px">{{$patient->nomPrenom}}</code> : {{count($consultations)}} 
                ...
                <div class="col-12 col-sm-6 col-md-2">
                    <a href="{{route("consultation.index")}}" class="btn btn-outline-primary btn-sm"><i
                            class="feather icon-users"></i> Liste patient</a>
                </div>
            </div>
        </div>
        <div class="card-body">
                ...
                <table class="striped">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 40%">SERVICE</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td></td>
                            <td>{{dateTime($consultation->dateConsultation)}}</td>
                            ...
                            <td class="text-center">
                                ...
                                <a class="btn btn-link {{empty($consultation->controles->all()) ? 'disabled' : ''}}" href="{{empty($consultation->controles->all()) ? '#' : route('historique.controle.index',$consultation->id)}}" title="Controle">
                                    <!-- https://feathericons.dev/?search=list&iconset=feather -->
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                                        class="main-grid-item-icon" fill="none" stroke="currentColor"
                                        stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
