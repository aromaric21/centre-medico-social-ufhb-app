...
<body class="card-pdf">
    ...
    <table>
        <tr class="bg-primary-pdf">
            <th class="text-light-pdf titre-detail-pdf" style="width:100%;">Informations Controles</th>
        </tr>
    </table><br><br>
    ...
    <table class="">
        <tbody class="card-pdf">
                <tr class="text-center-pdf">
                    <td class="text-primary-pdf" style="width:100%; font-size:17px;" colspan="3">
                        Date de controle
                    </td>
                </tr>
                <tr class="text-center-pdf">
                    <td style="width:100%; font-size:15px;" colspan="3">
                        {{dateTime($controle->dateControle) }}
                    </td>
                </tr>

                <tr class="text-primary-pdf text-center-pdf">
                    <td style="width:47.5%; font-size:17px;">
                        Etat santé
                    </td>
                    <td style="width:5%;"></td>
                    <td class="text-primary-pdf" style="width:47.5%; font-size:17px;">
                        Observation
                    </td>
                </tr>
                <tr class="text-center-pdf">
                    <td style="width:45%; font-size:15px;">
                        {{$controle->etatSante }}
                    </td>
