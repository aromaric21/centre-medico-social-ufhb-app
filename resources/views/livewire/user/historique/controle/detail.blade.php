            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route("historique.consultation.index",$consultation->id)}}">Liste des
                                consultation</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#" wire:click='listeControle()'>Liste des
                            controles</a>
                        </li>
        ...
        <div class="card container">
            ...
            <div class="medecinePDF fichePatient">
                ...
                <div class="card-header d-flex justify-content-between">
                    <h4 class="">Patient <code>{{optional($consultation->patient)->nomPrenom}}</code></h4>
                    <h5>Docteur
                ...
                <div class="card-body">
                    ...
                    <h4 class="bg-primary text-center text-light">Informations du Controle</h4>
                <div class="p-4">
                    <div class="text-center">
                        <h5 class="text-primary">Date de Controle</h5>
                        <span class="p-2 text-center">{{dateTime(optional($controle)->dateControle)}}</span>
                    </div>

                    <div class="d-flex justify-content-center mt-3">
                        <div class="mr-5">
                            <h5 class="text-primary">Etat santé</h5>
                            <span class="p-2">{{optional($controle)->etatSante}}<span>
                        </div>
                        <div class="">
                            <h5 class="text-primary ml-5">Observation</h5>
                            <span class="p-2">{{optional($controle)->observation}}</span>
                        </div>
                ...
                <h4 class="bg-primary text-center text-light">Consultation liée a ce controle</h4>
                ...
                <div class="container ">
                    <div class="d-flex justify-content-center mb-4 mt-3">
                        ...
                        <div class="d-flex justify-content-center ml-5">
                            ...
                            <h6 class="ml-2">{{optional($consultation->patient)->numeroFiche}}</h6>
                                ...
                                <div class="ml-3">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6 col-sm-12">
                                            ...
                                            <p class="sexe">{{optional($consultation->patient)->sexe}}</p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        @if (getRoleServiceName() !=='Cabinet dentaire')
                                            <div class="col-12 col-md-4 col-sm-12 mt-2">
                                                <div class="">
                                                    ...
                                                    <p>{{optional($consultation->examenPhysiques->first())->libelleExamenPhysique}}
                                                    </p>
