        ...
        <div class="card-body table-border-style">
                            ...
                            <div class="mb-0 text-primary">
                                <div class="form-group row">
                                    <div class="col-12 col-sm-12 col-md-4">
                                        <div class="form-group row fill mr-2">
                                            <label for="age"
                                                class="text-primary col-form-label col-12 col-sm-12 col-md-3">Age </label>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-4">
                                        <div class="row form-group">
                                            ...
                                            <div class="form-check col-12 col-sm-12 col-md-3 mt-3">
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-sm-12 col-md-6">
                                        <div class="row">
                                            <label for="contacts" class="col-12 col-sm-12 col-md-2 col-form-label">Contact</label>
                                            <div class="col-12 col-sm-12 col-md-7">
                                                <input type="text" class="form-control" name="contacts" id="contacts"
                                                    placeholder="Contact" wire:model='newPatientConsultation.contact'>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="modal-footer mb-3">
                <button class="btn  btn-primary mt-3"
                     wire:click='addExPatientConsultation()'>Enregistrer</button>
            </div>
        </div>
