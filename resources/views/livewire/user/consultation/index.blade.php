<div>
    ...
    @if ($currentPage == PAGELISTPATIENT)
        @include('livewire.user.consultation.liste')
    @endif

    @if ($currentPage == PAGEEXPATIENTFORM)
        @include('livewire.user.consultation.ex-patient')
    @endif
    

    @if ($currentPage == PAGESUITECONSULTATIONFORM)
        @include('livewire.user.consultation.suite-consultation')
    @endif

    @if ($currentPage == PAGENEWPATIENT)
        @include('livewire.user.consultation.new-patient')
    @endif
</div>
