        ...
        <div class="card-header">
            <div class="d-flex justify-content-between">
                <div class="col-12 col-sm-12 col-md-5">
                    <h5 ><i class="feather icon-user-plus mr-2"></i>Ajouter un utilisateur</h5>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="form-group fill">
                            ...
                            <select wire:model='newUser.role_id' id="service" class="form-control @error('newUser.role_id') is-invalid @enderror">
                                <option value=""></option>
